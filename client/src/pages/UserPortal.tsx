...
export default function UserPortal() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      {/* Navigation Header */}
      <nav className="portal-topnav fixed top-0 left-0 right-0 z-50 bg-white border-b-2 md:border-b-[3px] border-black pt-[env(safe-area-inset-top)]" role="navigation" aria-label="Main navigation">
      ...
      <div className="pt-24 md:pt-24 pb-24 md:pb-12">
        <AnimatePresence>
          ...
          {currentSection === 5 && (
            ...
            >
              <Suspense fallback={null}><ConvertSection /></Suspense>
            </motion.section>
          )}
          {currentSection === 6 && (
            <motion.section

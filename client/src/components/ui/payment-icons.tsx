...
export const JazzCashLogo: React.FC<{ className?: string }> = ({ className = "w-20 h-20" }) => (
  <div className={`${className} flex items-center justify-center bg-white rounded-lg p-3 border-3 border-black shadow-[6px_6px_0px_0px_rgba(20, 20, 19,1)] hover:shadow-[8px_8px_0px_0px_rgba(20, 20, 19,1)] transition-all`}>
    <img 

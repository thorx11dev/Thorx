...
import { Inbox, Users, ListChecks, MessagesSquare, MessageCircle, Swords, Search, BarChart3, Settings, Menu, ArrowRight, ArrowLeft, Megaphone, Shield, Send, Link2, Plus, Crown, Clock3 } from "lucide-react";
          ...
          <PremiumCard interactive={false}>
            <div className="flex items-center gap-3 mb-5">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[9px] font-mono font-bold tracking-[0.2em] text-black/40 uppercase mt-0.5">Pin a message · Members see a banner</div>
              </div>
            </div>
